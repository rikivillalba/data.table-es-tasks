...
FALSE`. Podemos ver que `r flights[!is.na(arr_delay) & !is.na(dep_delay), .N,
.(dep_delay>0, arr_delay>0)][, N[4L]]` los vuelos partieron tarde pero llegaron
temprano (o a tiempo).=====
...
resultado una longitud de ` 6+4+2 = `r 6+4+2``, mientras que (2) devuelve
`1+1+1=`r 1+1+1``.
